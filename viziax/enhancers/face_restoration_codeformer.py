...
from viziax.vendored.basicsr.img_util import img2tensor, tensor2img
from viziax.vendored.codeformer.codeformer_arch import CodeFormer
from viziax.vendored.facexlib.utils.face_restoration_helper import FaceRestoreHelper
...
def patch_download_function_in_facexlib_modules():
    ...
    import viziax.vendored.facexlib.utils.misc
    from viziax.vendored.facexlib import (
        alignment,
        assessment,
        detection,
        headpose,
    ...
    modules = [
        ...
        tracking,
        visualization,
        viziax.vendored.facexlib.utils.misc,
    ]
    for m in modules:
