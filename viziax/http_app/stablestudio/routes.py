...
from viziax.http_app.stablestudio.models import (
...
from viziax.http_app.utils import generate_image_b64
...
async def generate(studio_request: StableStudioBatchRequest):
    from viziax.http_app.app import gpu_lock
...
async def list_samplers():
    from viziax.config import SOLVER_CONFIGS
...
async def list_models():
    from viziax.config import MODEL_WEIGHT_CONFIGS
