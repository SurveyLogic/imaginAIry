...
from viziax import config as iconfig
from viziax.config import IMAGE_WEIGHTS_SHORT_NAMES, ModelArchitecture
from viziax.modules import attention
from viziax.modules.refiners_sd import (
    SDXLAutoencoderSliced,
    StableDiffusion_XL,
    StableDiffusion_XL_Inpainting,
)
from viziax.utils import clear_gpu_cache, get_device, instantiate_from_config
from viziax.utils.downloads import (
...
from viziax.utils.model_cache import memory_managed_model
...
from viziax.weight_management import translators
...
def load_sd15_diffusers_weights(base_url: str, device=None):
    ...
    from viziax.weight_management.utils import (
        COMPONENT_NAMES,
        FORMAT_NAMES,
        MODEL_NAMES,
    )
...
def open_weights(filepath, device=None):
    ...
    if "safetensor" in filepath.lower():
        from viziax.vendored.refiners.fluxion.utils import safe_open
