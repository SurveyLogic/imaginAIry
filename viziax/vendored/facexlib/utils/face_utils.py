...
if __name__ == '__main__':
    ...
    from viziax.vendored.facexlib.detection import init_detection_model
    from viziax.vendored.facexlib.utils.face_restoration_helper import get_largest_face
    from viziax.vendored.facexlib.visualization import visualize_detection
