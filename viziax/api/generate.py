...
def imagine_image_files(
    ...
    from viziax.utils import get_next_filenumber, prompt_normalized
    ...
    for result in imagine(
        ...
        if primary_filename and videogen:
            from viziax.api.video_sample import generate_video
...
def save_image_result(
    ...
    from viziax.utils import prompt_normalized
    from viziax.utils.animations import make_bounce_animation
...
def imagine(
    ...
    if get_device() == "cpu":
        ...
        from viziax.utils.torch_installer import torch_version_check
