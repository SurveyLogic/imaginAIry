...
from viziax.api.generate import IMAGINAIRY_SAFETY_MODE
from viziax.utils import seed_everything
from viziax.utils.img_utils import calc_scale_to_fit_within, combine_image
...
def _generate_single_image(
    ...
    from viziax.modules.midas.api import torch_image_to_depth_map
    from viziax.samplers import SOLVER_LOOKUP
    from viziax.samplers.editing import CFGEditingDenoiser
    from viziax.schema import (
        ControlInput,
        ImagineResult,
        LazyLoadingImage,
        MaskMode,
