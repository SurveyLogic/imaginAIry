...
from viziax.config import CONTROL_CONFIG_SHORTCUTS
from viziax.schema import ControlInput, ImaginePrompt, MaskMode
from viziax.utils import clear_gpu_cache, seed_everything
from viziax.utils.log_utils import ImageLoggingContext
...
def generate_single_image(
    ...
    from viziax.api.generate import (
    ...
    from viziax.enhancers.upscale import upscale_image
    from viziax.samplers import SolverName
    from viziax.schema import ImagineResult
    from viziax.utils import get_device, randn_seeded
    ...
    from viziax.utils.outpaint import (
        outpaint_arg_str_parse,
        prepare_image_for_outpaint,
    )
    from viziax.utils.safety import create_safety_score
    from viziax.vendored.refiners.foundationals.latent_diffusion.schedulers import (
        DDIM,
        DPMSolver,
    )
...
def _generate_composition_image(
    ...
    from viziax.utils import default, get_default_dtype
    from viziax.utils.img_utils import calc_scale_to_fit_within
