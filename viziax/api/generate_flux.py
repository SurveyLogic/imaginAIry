...
from viziax.schema import ImaginePrompt, ImagineResult
...
def load_flux_models():
    ...
    from viziax.utils.downloads import get_cache_dir
        ...
        if is_filtered:
            ...
            if add_caption:
                with lc.timing("caption-img"):
                    from viziax.enhancers.describe_image_blip import (
                        generate_caption,
                    )
            ...
            if prompt.fix_faces:
                with lc.timing("face-enhancement"):
                    from viziax.enhancers.face_restoration_codeformer import (
                        enhance_faces,
                    )
