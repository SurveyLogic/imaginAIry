...
def _create_depth_map_raw(
    ...
    from viziax.modules.midas.api import MiDaSInference, midas_device
...
def create_normal_map(img: "Tensor") -> "Tensor":
    ...
    from viziax.vendored.imaginairy_normal_map.model import (
...
def create_hed_edges(img_t: "Tensor") -> "Tensor":
    ...
    from viziax.img_processors.hed_boundary import create_hed_map
...
def create_pose_map(img_t: "Tensor"):
    from viziax.img_processors.openpose import create_body_pose_img
    from viziax.utils import get_device
...
def create_densepose_map(img_t: "Tensor") -> "Tensor":
    ...
    from viziax.img_processors.densepose import generate_densepose_image
