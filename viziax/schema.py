...
class ImaginePrompt(BaseModel, protected_namespaces=()):
    ...
    def resolve_model_weights(cls, data: Any):
        ...
        from viziax.utils.model_manager import resolve_model_weights_config
    ...
    def validate_image_size(cls, v, info: core_schema.FieldValidationInfo):
        from viziax.utils.model_manager import get_model_default_image_size
    ...
    def aspect_ratio(self) -> str:
        from viziax.utils.img_utils import aspect_ratio
...
class ImagineResult:
    def __init__(
        ...
        from viziax.utils import get_device, get_hardware_description
