...
def _imagine_cmd(
    *,
    ...
    from viziax.utils import glob_expand_paths
    ...
    for _init_image in init_images:
        if _init_image and _init_image.startswith("http"):
            ...
            from viziax.utils import named_resolutions
            from viziax.utils.text_image import image_from_textimg_str
    ...
    for _ in range(repeats):
        for prompt_text in prompt_texts:
            ...
            for _init_image in init_images:
                ...
                from viziax.utils.prompt_schedules import (
                    parse_schedule_strs,
                    prompt_mutator,
                )
    ...
    if make_compilation_animation:
        ...
        from viziax.utils.animations import make_slideshow_animation
