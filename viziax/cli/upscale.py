...
from viziax.config import DEFAULT_UPSCALE_MODEL
...
def upscale_cmd(
    ...
    from viziax.enhancers.upscale import upscale_image, upscale_model_lookup
    from viziax.schema import LazyLoadingImage
    from viziax.utils import glob_expand_paths
    from viziax.utils.format_file_name import format_filename, get_url_file_name
