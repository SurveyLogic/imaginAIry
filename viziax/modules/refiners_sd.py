...
import viziax.vendored.refiners.fluxion.layers as fl
from viziax import config
from viziax.schema import WeightedPrompt
from viziax.utils.downloads import get_cached_url_path
from viziax.utils.feather_tile import rebuild_image, tile_image
from viziax.vendored.refiners.fluxion.layers.attentions import (
    ScaledDotProductAttention,
)
from viziax.vendored.refiners.fluxion.layers.chain import ChainError
from viziax.vendored.refiners.fluxion.utils import image_to_tensor, interpolate
from viziax.vendored.refiners.foundationals.clip.text_encoder import (
    CLIPTextEncoderL,
)
from viziax.vendored.refiners.foundationals.latent_diffusion import (
    SD1IPAdapter,
    SDXLIPAdapter,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.model import (
    TLatentDiffusionModel,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.schedulers.ddim import (
    DDIM,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.schedulers.scheduler import (
    Scheduler,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.self_attention_guidance import (
    SelfAttentionMap,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.stable_diffusion_1.controlnet import (
    Controlnet,
    SD1ControlnetAdapter,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.stable_diffusion_1.model import (
    SD1Autoencoder,
    SD1UNet,
    StableDiffusion_1 as RefinerStableDiffusion_1,
    StableDiffusion_1_Inpainting as RefinerStableDiffusion_1_Inpainting,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.stable_diffusion_xl.model import (
    SDXLAutoencoder,
    StableDiffusion_XL as RefinerStableDiffusion_XL,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.stable_diffusion_xl.text_encoder import (
    DoubleTextEncoder,
)
from viziax.vendored.refiners.foundationals.latent_diffusion.stable_diffusion_xl.unet import (
    SDXLUNet,
)
from viziax.weight_management.conversion import cast_weights
from viziax.weight_management.translators import (
...
class StableDiffusion_1(TileModeMixin, SD1ImagePromptMixin, RefinerStableDiffusion_1):
    ...
    def calculate_text_conditioning_kwargs(
        ...
        from viziax.utils.log_utils import log_conditioning
...
def get_controlnet(name, weights_location, device, dtype):
    from viziax.utils.model_manager import load_state_dict
